...
public class HttpRequest implements org.apache.thrift.TBase<HttpRequest, HttpRequest._Fields>, java.io.Serializable, Cloneable, Comparable<HttpRequest> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> headers; // optional
  ...
  public HttpRequest setUrl(@org.apache.thrift.annotation.Nullable java.lang.String url) {
    this.url = url;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.headers = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map8.size);
      ...
      if (struct.headers != null) {
        if (struct.isSetHeaders()) {
          oprot.writeFieldBegin(HEADERS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter12 : struct.headers.entrySet())
            {
      ...
      if (struct.isSetHeaders()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter13 : struct.headers.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.headers = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map14.size);
